"use strict";
const { oauthClientID, oauthClientSecret, callbackURL, production, callbackURLDev, facebookAppID, facebookAppSecret, twitterConsumerID, twitterConsumerSecret, githubClientID, githubClientSecret, } = require('../config/index.config');
