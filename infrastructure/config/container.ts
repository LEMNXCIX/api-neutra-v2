...
export class Container {
    ...
    private static whatsappConfigRepo = new WhatsAppConfigPrismaRepository(
        prisma,
    );
    private static whatsappMessageRepo = new WhatsAppMessagePrismaRepository(
        prisma,
    );
    private static whatsappConversationRepo =
        new WhatsAppConversationPrismaRepository(prisma);
    ...
    private static whatsappBotService = new WhatsAppBotService(
        this.whatsappConversationRepo,
        this.whatsappMessageRepo,
    ...
    public static getUserController(): UserController {
        return new UserController(
            ...
            new GetOrCreateByProviderUseCase(
                this.userRepository,
                this.cartRepository,
                this.roleRepository,
                this.uidProvider,
    ...
    public static getAuthController(): AuthController {
        return new AuthController(
            ...
            new ResetPasswordUseCase(this.userRepository, this.passwordHasher),
        );
    }
    ...
    public static getFeatureController(): FeatureController {
        return new FeatureController(
            ...
            new CreateFeatureUseCase(this.featureRepository),
            new UpdateFeatureUseCase(this.featureRepository),
            new DeleteFeatureUseCase(this.featureRepository),
        );
    }
    ...
    public static getStaffController(): StaffController {
        return new StaffController(
            new CreateStaffUseCase(
                this.staffRepository,
                this.userRepository,
                this.roleRepository,
            ),
            new GetStaffUseCase(this.staffRepository),
            new GetStaffByUserIdUseCase(this.staffRepository),
            new UpdateStaffUseCase(
                this.staffRepository,
                this.userRepository,
                this.roleRepository,
            ),
            new DeleteStaffUseCase(this.staffRepository),
            new AssignStaffServiceUseCase(this.staffRepository),
            new SyncStaffServicesUseCase(this.staffRepository),
        );
    }
    ...
    public static getServiceController(): ServiceController {
        return new ServiceController(
            ...
            new GetServicesUseCase(this.serviceRepository),
            new UpdateServiceUseCase(
                this.serviceRepository,
                this.categoryRepository,
            ),
            new DeleteServiceUseCase(this.serviceRepository),
        );
    }
    ...
    public static getLogController(): LogController {
        return new LogController(
            new GetLogsUseCase(this.logRepository),
            new GetLogStatsUseCase(this.logRepository),
        );
    }
    ...
    public static getWhatsAppConfigController(): WhatsAppConfigController {
        return new WhatsAppConfigController(
            new GetWhatsAppConfigUseCase(this.whatsappConfigRepo),
            new ConfigureWhatsAppUseCase(
                this.whatsappConfigRepo,
                this.featureRepository,
            ),
        );
    ...
    public static getLogRepository(): ILogRepository {
    ...
    public static getFeatureRepository(): IFeatureRepository {
    ...
    public static getAppointmentRepository(): IAppointmentRepository {
    ...
    public static getStaffRepository(): IStaffRepository {
    ...
    public static getSlideRepository(): ISlideRepository {
        return this.slideRepository;
    }

    public static getServiceRepository(): IServiceRepository {
        return this.serviceRepository;
    }

    public static getWhatsAppConfigRepository(): IWhatsAppConfigRepository {
        return this.whatsappConfigRepo;
    }

    public static getWhatsAppMessageRepository(): IWhatsAppMessageRepository {
        return this.whatsappMessageRepo;
    }

    public static getWhatsAppConversationRepository(): IWhatsAppConversationRepository {
        return this.whatsappConversationRepo;
    }
}
