...
export class AppointmentController {
    ...
    async create(req: Request, res: Response) {
        ...
        this.logger.info(
            `[AppointmentController] Create origin captured: ${origin}`,
            {
        ...
        if (result.success && result.data) {
            result.data = AppointmentPresenter.toResponse(result.data) as any;
        }
    ...
    async getAll(req: Request, res: Response) {
        ...
        if (result.success && result.data) {
            result.data = AppointmentPresenter.toResponseList(result.data) as any;
        }
    ...
    async cancel(req: Request, res: Response) {
        ...
        if (features["EMAIL_NOTIFICATIONS"]) {
            ...
            this.logger.info(
                "Skipping email notification: EMAIL_NOTIFICATIONS feature disabled",
                { tenantId },
            );
        }

        const data = AppointmentPresenter.toResponse(appointment);
        return res.json(Success(data, "Appointment cancelled successfully"));
    }
